...
credentials ++= Seq(
  Credentials(
    ...
    "$PASSWORD"))
```
- Create a PGP key, for example on [keybase.io](https://keybase.io/)
...
- Pick a release name from [here](https://en.wikipedia.org/wiki/List_of_Latin_phrases_(full)), [here](https://en.wikipedia.org/wiki/List_of_songs_with_Latin_lyrics) or other interesting sources
...
- Update [homebrew formula](https://github.com/spotify/homebrew-public/blob/master/scio.rb)
- Bump version in the public [scio.g8](https://github.com/spotify/scio.g8) and the internal cookie
...
- Announce on internal Slack and public Gitter [room](gitter.im/spotify/scio)
- Announce on Twitter
